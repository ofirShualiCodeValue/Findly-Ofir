...
/**
 * Great-circle ("Air distance") between two points using the Haversine
 * formula. Inputs in decimal degrees; output in kilometers. Used by the
 * matcher below to filter events by the worker's `location_range_km`.
 */
